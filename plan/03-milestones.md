...
| M7: hardened release candidate | Core protection/migration, native key vaults and backup export/inspection tested; protected app startup and restore open | Protected storage, backup/recovery/migration tests, dependency/license review, independent security review and a clean supported-device matrix |
