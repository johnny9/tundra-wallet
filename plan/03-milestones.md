...
| M7: hardened release candidate | Protected Rust storage and atomic plaintext migration tested; native keys and recovery open | Protected storage, backup/recovery/migration tests, dependency/license review, independent security review and a clean supported-device matrix |
